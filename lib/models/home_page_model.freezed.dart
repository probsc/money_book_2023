...
class _$_HomePageModel implements _HomePageModel {
  const _$_HomePageModel({required final List<Records> records})
      : _records = records;
  ...
  @override
  String toString() {
    return 'HomePageModel(records: $records)';
  }
...
abstract class _HomePageModel implements HomePageModel {
  const factory _HomePageModel({required final List<Records> records}) =
      _$_HomePageModel;
